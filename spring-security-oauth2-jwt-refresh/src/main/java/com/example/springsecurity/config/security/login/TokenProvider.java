...
public class TokenProvider {
    ...
    private static final String AUTHPROVIDER = "authProvider";
    ...
    private String createToken(Authentication authentication, long accessTokenExpirationTimeInMilliSeconds) {
        ...
        return Jwts.builder()
                ...
                .claim(AUTHPROVIDER,memberPrincipal.getMember().getAuthProvider())
                .setIssuedAt(now)
    ...
    public AuthProvider getAuthProviderFromToken(String token) {
        Claims claims = Jwts.parser()
                ...
                .parseClaimsJws(token)
                .getBody();
        String authProviderType = claims.get(AUTHPROVIDER, String.class);
