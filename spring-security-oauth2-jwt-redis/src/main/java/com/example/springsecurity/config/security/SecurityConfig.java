...
import com.example.springsecurity.config.security.login.filter.TokenAuthenticationErrorFilter;
import com.example.springsecurity.config.security.login.filter.TokenAuthenticationFilter;
import com.example.springsecurity.config.security.login.handler.LoginFailureHandler;
import com.example.springsecurity.config.security.login.handler.LoginSuccessHandler;
import com.example.springsecurity.config.security.login.handler.RestAccessDeniedHandler;
...
//    }
    ...
    public LoginFilter loginFilter() throws Exception {
        ...
        loginFilter.setAuthenticationFailureHandler(loginFailureHandler); // 필터 안에서 예외 터질 경우
        return loginFilter;
    }
