...
public class StudyControllerTest extends AbstractContainerBaseTest {
    ...
    void createStudy_success() throws Exception {
        ...
        assertNotNull(study);
        Account account = accountRepository.findByNickname("backtony");
    ...
    void viewStudy() throws Exception {
        ...
        Account keesun = accountRepository.findByNickname("backtony");
    ...
    void joinStudy() throws Exception {
        ...
        assertTrue(study.getMembers().contains(backtony));
    }
    ...
    void leaveStudy() throws Exception {
        ...
        Account backtony = accountRepository.findByNickname("backtony");
        studyService.addMember(study, backtony);

        mockMvc.perform(get("/study/" + study.getPath() + "/leave"))
                .andExpect(status().is3xxRedirection())
                .andExpect(redirectedUrl("/study/" + study.getPath() + "/members"));

        assertFalse(study.getMembers().contains(backtony));
    }
